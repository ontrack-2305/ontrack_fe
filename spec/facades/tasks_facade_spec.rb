...
RSpec.describe TasksFacade do
  it "can post a task" do
    ...
    stub_request(:post, "http://our_render_url.com/api/v1/users/1/tasks?event_date=&frequency=Weekly&mandatory=1&name=Water%20Plants&notes=Remember%20plants%20in%20bedroom,%20living%20room,%20and%20balcony&time_needed=20&type=Chore").
         with(
           headers: {
          'Accept'=>'*/*',
